...
combined_true_imu = [time, gyro_true, accel_true];
combined_true_mag = [mag_true];
...
combined_corr_imu = [gyro_corr, accel_corr];
combined_corr_mag = [mag_corr];

%writematrix(combined_true, 'exported_stuff/combined_true.csv');
%writematrix(combined_corr, 'exported_stuff/combined_corr.csv');
writematrix(combined_true_imu, 'exported_stuff/imu_true.csv');
writematrix(combined_corr_imu, 'exported_stuff/imu_corr.csv');
writematrix(combined_true_mag, 'exported_stuff/mag_true.csv');
writematrix(combined_corr_mag, 'exported_stuff/mag_corr.csv');
