...
class Kalman:
    ...
    def process_covariance(self, time_delta):
        ...
        Q[19, 19] = self.barometer_bias_cov*time_delta

        return Q

    def unbias_sensors(self, gyro_meas, acc_meas, mag_meas, baro_meas):
        pass

    def fastGyroAccelProp(self, gyro_meas, acc_meas, time_delta):
    ...
    def ekfPredict(self, gyro_meas, acc_meas, time_delta):
        pass

    def acc_mag_Update(self, acc_meas, mag_meas):
        pass

    def gps_update(self, gps_pos, gps_vel):
        pass

    def baro_update(self, baro_meas):
        pass



        
    def update(self, gyro_meas, acc_meas, mag_meas, baro_meas, time_delta):
        
        gyro_meas = gyro_meas - self.gyro_bias
        acc_meas = acc_meas - self.accelerometer_bias
        mag_meas = mag_meas - self.magnetometer_bias
        baro_meas = baro_meas - self.barometer_bias
